...
COPY /gitpod_conf/mysql_conf/mysql.cnf /etc/mysql/mysql.conf.d/mysqld.cnf

# Install default-login for MySQL clients
COPY /gitpod_conf/mysql_conf/client.cnf /etc/mysql/mysql.conf.d/client.cnf

COPY /gitpod_conf/mysql_conf/mysql-bashrc-launch.sh /etc/mysql/mysql-bashrc-launch.sh
